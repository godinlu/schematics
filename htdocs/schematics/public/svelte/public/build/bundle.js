...
var app = (function () {
    ...
    */
     ...
     */
    window.global_vars["all_articles"];

    /**
     * @type {category[]} categories
     */
    window.global_vars["categories"];
    ...
    const file$1 = "src\\devis\\Category.svelte";

    function create_fragment$2(ctx) {
    	let h1;
    	let t_value = /*category*/ ctx[0].name + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(t_value);
    			add_location(h1, file$1, 7, 0, 150);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*category*/ 1 && t_value !== (t_value = /*category*/ ctx[0].name + "")) set_data_dev(t, t_value);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Category, category });
    ...
    class Category_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\devis\Quotation.svelte generated by Svelte v3.59.2 */
    const file = "src\\devis\\Quotation.svelte";
    ...
    // (23:8) {#each categories.get_base_categories() as category (category.id)}
    function create_each_block(key_1, ctx) {
    	let first;
    	let category;
    	let current;

    	category = new Category_1({
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:8) {#each categories.get_base_categories() as category (category.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let current;
    	let each_value = /*categories*/ ctx[0].get_base_categories();
    	validate_each_argument(each_value);
    	const get_key = ctx => /*category*/ ctx[1].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 12, 12, 304);
    			attr_dev(div1, "class", "custom-col");
    			add_location(div1, file, 13, 12, 357);
    			attr_dev(div2, "class", "custom-col");
    			add_location(div2, file, 14, 12, 412);
    			attr_dev(div3, "class", "custom-col");
    			add_location(div3, file, 15, 12, 464);
    			attr_dev(div4, "class", "custom-col");
    			add_location(div4, file, 16, 12, 518);
    			attr_dev(div5, "class", "custom-col");
    			add_location(div5, file, 17, 12, 562);
    			attr_dev(div6, "class", "custom-row");
    			add_location(div6, file, 11, 8, 266);
    			attr_dev(div7, "class", "custom-header svelte-o6xd8l");
    			add_location(div7, file, 10, 4, 229);
    			attr_dev(div8, "class", "grid-body");
    			add_location(div8, file, 21, 4, 628);
    			attr_dev(div9, "class", "custom-table svelte-o6xd8l");
    			add_location(div9, file, 9, 0, 197);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*categories*/ 1) {
    				each_value = /*categories*/ ctx[0].get_base_categories();
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, div8, outro_and_destroy_block, create_each_block, null, get_each_context);
    				check_outros();
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Quotation', slots, []);
    	let categories = new Categories();
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Quotation> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Categories, Category: Category_1, categories });
    ...
    class Quotation extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_if_block(ctx) {
    	let quotation;
    	let current;
    	quotation = new Quotation({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(quotation.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(quotation, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(quotation.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(quotation.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(quotation, detaching);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Quotation, title });
