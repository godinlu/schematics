...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 16, 4, 406);
    		},
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 18, 12, 502);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    class Modal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { modal_show: 0, slot_key: 1 });
    ...
    */
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i1 = element("i");
    			add_location(td0, file$4, 20, 4, 547);
    			add_location(td1, file$4, 21, 4, 575);
    			attr_dev(input, "type", "number");
    			attr_dev(input, "min", "1");
    			attr_dev(input, "max", "99");
    			add_location(input, file$4, 22, 8, 609);
    			add_location(td2, file$4, 22, 4, 605);
    			add_location(td3, file$4, 23, 4, 688);
    			attr_dev(i0, "class", "fa-solid fa-pen");
    			add_location(i0, file$4, 25, 40, 763);
    			add_location(button0, file$4, 25, 8, 731);
    			add_location(td4, file$4, 24, 4, 717);
    			attr_dev(i1, "class", "fa-solid fa-trash");
    			add_location(i1, file$4, 28, 43, 869);
    			add_location(button1, file$4, 28, 8, 834);
    			add_location(td5, file$4, 27, 4, 820);
    			add_location(tr, file$4, 19, 0, 537);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (20:0) {#each articles as article (article.ref)}
    function create_each_block$3(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:0) {#each articles as article (article.ref)}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const get_key = ctx => /*article*/ ctx[5].ref;
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 37, 16, 1129);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(td0, file, 31, 20, 952);
    			add_location(td1, file, 32, 20, 996);
    			add_location(td2, file, 33, 20, 1042);
    			attr_dev(tr, "class", "svelte-1h7e1av");
    			add_location(tr, file, 30, 16, 881);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file, 23, 16, 661);
    			attr_dev(th1, "class", "svelte-1h7e1av");
    			add_location(th1, file, 24, 16, 697);
    			attr_dev(th2, "class", "svelte-1h7e1av");
    			add_location(th2, file, 25, 16, 735);
    			attr_dev(tr, "class", "svelte-1h7e1av");
    			add_location(tr, file, 22, 12, 639);
    			attr_dev(thead, "class", "svelte-1h7e1av");
    			add_location(thead, file, 21, 8, 618);
    			add_location(tbody, file, 28, 8, 801);
    			attr_dev(table, "class", "style-table svelte-1h7e1av");
    			add_location(table, file, 20, 4, 581);
    			attr_dev(div, "class", "scroll-container svelte-1h7e1av");
    			add_location(div, file, 19, 0, 545);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
