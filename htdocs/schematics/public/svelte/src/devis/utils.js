 ...
 * @returns {category[]}
 */
export function get_base_categories(categories){
 ...
 * @returns 
 */
export function get_path_category(categories, category_id){
 ...
 * @returns 
 */
export function get_category_from_id(categories, category_id){
 ...
 * @returns {categorie[]}
 */
export function get_sub_categories(categories, category_id){
 ...
 * @returns {categorie[]}
 */
export function get_articles_by_categ(articles, category_id){
 ...
 * @returns {article}
 */
export function get_article_by_ref(articles, categories, ref){
