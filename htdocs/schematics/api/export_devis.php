...
try {
    ...
    $stmt = $pdo->query("
        SELECT CONCAT(d.reference, IF(d.version > 1, CONCAT('-V', d.version), '')) AS reference,
                d.date_devis, d.affaire, d.installateur_entreprise,
               d.type_devis, d.cout_total_ht, d.cout_total_ttc,
               d.taux_remise, d.taux_tva, d.code_tva, d.objet,
               d.installateur_nom_prenom, d.installateur_mail, d.affaire_suivie_par,
               d.mode_reglement, d.validite, d.delai_livraison
        FROM devis_genere d
    ");
